...
@profile 
def calc_pure_python_(draw_output, desired_width, max_iterations):
...
# Calculate this Julia set using a pure Python solution with 
# reasonable defaults for a laptop 
# set draw_output to True to use PIL to draw an image 
calc_pure_python_(draw_output=False, desired_width=1000, max_iterations=300)