...
def main():
    ...
    currentPlayer, nextPlayer = X, O    # X goes first , O next 

    while True:
        print(getBoardStr(gameBoard))


        # Keep asking  player until they enter a number 1-9:
        move = None 
        ...
        if isWinner(gameBoard, currentPlayer):
            ...
            break 
        currentPlayer, nextPlayer = nextPlayer, currentPlayer  # swapping tunrs 
...
def getBlankBoard():
    ...
    board = {}  # The board is represented as a dictionary 
...
def isValidSpace(board, space):
    """ Return True if the space on the board is a valid space number 
...
def isWinner(board, player):
    ...
    return ((b['1'] == b['2'] == b['3'] == p ) or # Acorss the top 
            (b['4'] == b['5'] == b['6'] == p ) or # Across the middle 
            (b['7'] == b['8'] == b['9'] == p ) or # Acorss the bottom 
